...
const vcard1 = 'BEGIN:VCARD\n'  // Gak Usah Di Ganti
            + 'VERSION:3.0\n'  // Gak Usah DiGanti
            + 'FN: MANS\n' //ganti nama bot lu
            + 'ORG: KUVIANTI INDONESIA NET BOT;\n' //Ganti Jadi Nama Lu
            + 'TEL;type=CELL;type=VOICE;waid=62882248593502:+62882248593502\n'  //ganti nomor lu! 
            + 'END:VCARD'
const vowner = 'BEGIN:VCARD\n'  // Gak Usah Di Ganti
            + 'VERSION:3.0\n'  // Gak Usah DiGanti
            + 'FN: COGNITA\n' //ganti nama bot lu
            + 'ORG: KUVIANTI INDONESIA NET BOT;\n' //Ganti Jadi Nama Lu
            + 'TEL;type=CELL;type=VOICE;waid=6287717710182:+6287717710182\n'  //ganti nomor lu! 
            + 'END:VCARD'
const vdev = 'BEGIN:VCARD\n'  // Gak Usah Di Ganti
            + 'VERSION:3.0\n'  // Gak Usah DiGanti
            + 'FN: VINZ\n' //ganti nama bot lu
            + 'ORG: PARTNER & DEVELOPER BOT KUVIANTI INDONESIA NET BOT;\n' //Ganti Jadi Nama Lu
            + 'TEL;type=CELL;type=VOICE;waid=6282140744548:+6282140744548\n'  //ganti nomor lu! 
            + 'END:VCARD'
prefix = '>' // Ganti Aja Terserah Lu 
cr = '*KUVIANTI INDONESIA NET BOT®*' 
blocked = []   //Jangan Ganti
limitawal = 10000000000000 //Bebas Ganti 
memberlimit = 1
fake= '*By COGNITA®*' 
numbernye = '0' // Jangan diganti anjing

/******** OWNER NUMBER**********/
const ownerNumber = ["6287717710182@s.whatsapp.net","62882248593502@s.whatsapp.net"]   // Ganti Nomor Lu
const pacarNumber = ["6287717710182@s.whatsapp.net"]  // Ganti Jadi Nomor Bot Lu
/************************************/
...
const client = new WAConnection()
   ...
   console.log(color('[','white'),color('∆','red'),color(']','white'),color('QR code is ready, Scan now..','white'),color('Cognita','red'),color('X','lime'),color('KUVIANTI INDONESIA NETBot','red'))
})
...
client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `*Yang keluar titip gorengan yak* @${num.split('@')[0]}\n*jangan lupa gak boleh masuk lagi!*`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
    ...
    try {
        ...
        const dataRevoke = JSON.parse(fs.readFileSync('./rsc/gc-revoked.json'))
        const dataCtRevoke = JSON.parse(fs.readFileSync('./rsc/ct-revoked.json'))
        const dataBanCtRevoke = JSON.parse(fs.readFileSync('./rsc/ct-revoked-banlist.json'))
        ...
        if (messageStubType == 'REVOKE') {
            ...
            let int
            let infoMSG = JSON.parse(fs.readFileSync('./rsc/.dat/msg.data.json'))
...
client.on('message-new', async(mek) => {
    try {
        ...
        fs.writeFileSync('./rsc/.dat/msg.data.json', JSON.stringify(infoMSG, null, 2))
        ...
        if (levelRole <= 2) {
            ...
            if (bad.includes(messagesC)) {
                if (!isGroupAdmins) {
                    return reply("JAGA UCAPAN DONG!! 😠")
                        ...
                        .then(() => {
                            client.sendMessage(from, `*「 ANTI BADWORD 」*\nKUVIANTI INDONESIA NET BOT akan kick kamu karena berkata kasar!`, text ,{quoted: mek})
          ...
          const checkLimit = (sender) => {
           ...
           return false
			...
			if (!isGroup && isCmd) console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;32mKUVIANTI INDONESIA NET MENJAWAB\x1b[1;37m]', time, color(command), 'from', color(sender.split('@')[0]), 'args :', color(args.length))
			if (!isGroup && !isCmd) console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;31mBUKAN COMMAND\x1b[1;37m]', time, color('Message'), 'from', color(sender.split('@')[0]), 'args :', color(args.length))
			
			//group message
			if (isCmd && isGroup) console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;32mKUVIANTI INDONESIA NET MENJAWAB\x1b[1;37m]', time, color(command), 'from', color(sender.split('@')[0]), 'in', color(groupName), 'args :', color(args.length))
			if (!isCmd && isGroup) console.log('\x1b[1;31m~\x1b[1;37m>', '[\x1b[1;31mBUKAN COMMAND\x1b[1;37m]', time, color('Message'), 'from', color(sender.split('@')[0]), 'in', color(groupName), 'args :', color(args.length))
			...
			switch(command) {
               ...
               case 'kontak':
                    ...
                    + 'END:VCARD'.trim()
                     client.sendMessage(from, {displayName: disname, vcard: vcard2}, contact)
                     break
                    case 'kontag':
					tyu = args[0]
					ajc = args[1]
            ...
            break
                ...
                if (argz[1] == 'aktif') {
                    if (isGroup) {
                        ...
                        fs.writeFileSync('./rsc/gc-revoked.json', JSON.stringify(dataRevoke, null, 2))
                    ...
                    if (!isGroup) {
                        ...
                        fs.writeFileSync('./rsc/ct-revoked.json', JSON.stringify(dataCtRevoke, null, 2))
                    ...
                    fs.writeFileSync('./rsc/ct-revoked-banlist.json', JSON.stringify(dataBanCtRevoke, null, 2))
...
case 'faketoko':
		...
		case 'jadwalbola': 			
				...
				if (isLimit(sender)) return reply(ind.limitend(pusname))
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
				data = await fetchJson(`https://api.vhtear.com/jadwalbola&apikey=MyMans1i`, {method: 'get'})
				teks = '=================\n'
...
if (isBanned) return reply('```Lu kebanned kontol```')
       ...
       exec(`wget ${anu1} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=20 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
				...
				client.sendMessage(from, buffer, image, {caption: 'Nih kak.. *Jangan Lupa Follow IG BOT : instagram.com/KUVIANTI INDONESIA NET.bot*', quoted: mek})
				await limitAdd(sender) 
				break
				case 'pornhub':
				var gh = body.slice(9) 
...
if (isBanned) return reply('```Lu kebanned kontol```')
		...
		case 'shrtco':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
				client.updatePresence(from, Presence.composing) 
				data = await fetchJson(`http://lolhuman.herokuapp.com/api/shortlink2?url=${args[0]}&apikey=RamlanID`)
				hasil = `link : ${args[0]}\n\nOutput : ${data.result}`
				reply(hasil)
				await limitAdd(sender)
				break
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					ranp = getRandom('.gif')
					rano = getRandom('.webp')
					anu = await fetchJson('https://kuv-api.herokuapp.com/api/nsfwblowjob?apikey=Kuv-Api', {method: 'get'})
					if (anu.error) return reply(anu.error)
		...
		case 'randomhentai':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					reply(ind.wait())
                                        anu = await fetchJson(`https://kuv-api.herokuapp.com/api/hentai?apikey=Kuv-Api`, {method: 'get'})
		...
		case 'nulis2':
                ...
                ll4 = ct.split("/")[3];
				reply(ind.wait())
				ct = await getBuffer(`https://api.zeks.xyz/api/magernulis?nama=${ll1}&kelas=${ll2}&text=${ll3}&tinta=${ll4}&apikey=apivinz`)
				client.sendMessage(from, ct, image, {caption: 'Nih kak udah jadi..', quoted: mek})
				await limitAdd(sender)
				break
		case 'nulis3':
				...
				ct = body.slice(6)
				reply(ind.wait())
				ct = await getBuffer(`https://kuv-api.herokuapp.com/api/nulis?text=${ct}&apikey=Kuv-Api`)
				client.sendMessage(from, ct, image, {caption: 'Nih kak udah jadi..', quoted: mek})
				await limitAdd(sender)
				break
		case 'galaxtext':
		...
		case 'darkneon':
				...
				if (isLimit(sender)) return reply(ind.limitend(pusname))
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
                    if (args.length == 0) return reply(`Usage: ${prefix + command} text\nExample: ${prefix + command} KUVIANTI INDONESIA NET`)
                    txt = args.join(" ")
                    reply('[â•] Loading')
                    buffer = await getBuffer(`https://videfikri.com/api/textmaker/${command}/?text=${txt}`)
                    client.sendMessage(from, buffer, image, {caption: 'Nih kak.. *Jangan lupa follow ig instagram.com/rinkashikimoz_*', quoted: mek})
         break
         case 'wanted':
	if (!isRegistered) return reply( ind.noregis())
				if (isLimit(sender)) return reply(ind.limitend(pusname))
...
break
         ...
         break 
				...
				gatauda = body.slice(8)
				reply(ind.wait())
				buffer = await getBuffer(`http://lolhuman.herokuapp.com/api/meme/darkjoke?apikey=RamlanID`, {method: 'get'})
				client.sendMessage(from, buffer, image, {quoted: mek})
				await limitAdd(sender)
				break
		case 'randomkpop':
		...
		case 'logoepep': 
				...
				reply(ind.wait())
				buffer = await getBuffer(`https://api.vhtear.com/logoff?hero=Maxim&text=${gatauda}&apikey=genbotkey`, {method: 'get'})
		...
		case 'logoepep4': 
				...
				if (args.length < 1) return reply('Teksnya mana um')
				reply(ind.wait())
				buffer = await getBuffer(`https://api.vhtear.com/logoff?hero=Caroline&text=${gatauda}&apikey=genbotkey`, {method: 'get'})
				client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nih hasilnya kak...'})
				await limitAdd(sender)
				break
		case 'logoepep5': 
				...
				if (args.length < 1) return reply('Teksnya mana um')
				reply(ind.wait())
				buffer = await getBuffer(`https://api.vhtear.com/logoff?hero=Kla&text=${gatauda}&apikey=genbotkey`, {method: 'get'})
				client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nih hasilnya kak...'})
				await limitAdd(sender)
				break
		case 'gamelogo': 
				...
				if (args.length < 1) return reply('Teksnya mana um')
				reply(ind.wait())
				buffer = await getBuffer(`https://api.vhtear.com/gamelogo?text=${gatauda}&apikey=genbotkey`, {method: 'get'})
				client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nih hasilnya kak...'})
				await limitAdd(sender)
				break
		case 'pornlogo': 
				...
				if (args.length < 1) return reply('Teksnya mana um')
				reply(ind.wait())
				buffer = await getBuffer(`https://api.vhtear.com/pornlogo?text1=${gbl7}&text2=${gbl8}&apikey=genbotkey`, {method: 'get'})
				client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Nih hasilnya kak...'})
				await limitAdd(sender)
				break
case 'joox':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
				data = await fetchJson(`https://kuv-api/api/joox?q=${body.slice(6)}&apikey=Kuv-Api`, {method: 'get'})
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
				data = await fetchJson(`https://api.zeks.xyz/api/joox?q=${body.slice(6)}&apikey=apivinz`, {method: 'get'})
				if (data.error) return reply(data.error)
				infomp3 = `*Lagu Ditemukan!!!*\nJudul : ${data.result.judul}\nAlbum : ${data.result.album}\nDipublikasi : ${data.result.dipublikasi}`
				buffer = await getBuffer(data.result.thumb)
				lagu = await getBuffer(data.result.mp3)
		...
		case 'play':
				...
				if (isLimit(sender)) return reply(ind.limitend(pusname)) 
                reply(ind.wait())
                anu = await fetchJson(`https://api.vhtear.com/ytmp3?query=${body.slice(6)}&apikey=BeliGoblokBetakMulu`)
               if (anu.error) return reply(anu.error)
...
case 'play3':
				...
				if (isLimit(sender)) return reply(ind.limitend(pusname)) 
                reply(ind.wait())
                anu = await fetchJson(`https://kuvianti-api.herokuapp.com/api/yt/playmp3?query=${body.slice(6)}&apikey=Kuv-Api`)
               if (anu.error) return reply(anu.error)
                 infomp3 = `*「❗」Lagu Ditemukan*\n➸ Judul : ${anu.result.title}\n➸ Durasi : ${anu.result.duration}\n➸ Size : ${anu.result.size}\n\n*[WAIT] Proses Dumlu Yakan*`
		...
		case 'play2':   
				...
				client.sendMessage(from, laguu , audio, {mimetype: 'audio/mp3', filename: `${anu.result.title}.mp3`, quoted: mek})
				await limitAdd(sender)
				break
		case 'limit':
		...
		case 'covidindo': 
               ...
               case 'covidwilayah': 
                ...
                if (isLimit(sender)) return reply(ind.limitend(pusname))
                if (isBanned) return reply('Maaf kamu sudah terbenned!')
                  data = await fetchJson(`https://zahirr-web.herokuapp.com/api/covidindo?apikey=zahirgans`)
                  hasil = `result : ${data.result.result}\nattributes : ${data.result.attributes}\nFID : ${data.result.fid}\nKode_Provi : ${data.result.kode_provi}\nProvinsi : ${data.result.provinsi}\nKasus_Posi : ${data.result.kasus_posi}\nKasus_Semb : ${data.result.kasus_semb}\nKasus_Meni : ${data.result.kasus_meni}`
                  reply(hasil)
                  await limitAdd(sender)
                break       
...
//					break
        case 'covidglobal':    
                ...
                client.updatePresence(from, Presence.composing) 
                tels = body.slice(12)
                asu = await fetchJson(`https://zahirr-web.herokuapp.com/api/covidworld?apikey=zahirgans`)
                ez = `*╠➥  totalCases :* ${asu.result.totalcases}\n*╠➥  recovered :* ${asu.result.recovered}\n*╠➥  deaths :* ${asu.result.deaths}\n*╠➥  activeCases :* ${asu.result.activeCases}\n*╠➥  closedCases :* ${asu.result.closedCases}\n`
                reply(ez)
                await limitAdd(sender)
                    break
		case 'ceknamaff': 
		...
		case 'infogempa':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					if (isLimit(sender)) return reply(ind.limitend(pusname))
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					anu = await fetchJson(`https://kuv-api.herokuapp.com/api/infogempa?apikey=Kuv-Api`, {method: 'get'})
					if (anu.error) return reply(anu.error)
  ...
  break
		case 'infocuaca':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					if (isLimit(sender)) return reply(ind.limitend(pusname))
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					anu = await fetchJson(`https://kuv-api.herokuapp.com/api/cuaca?wilayah=${tels}&apikey=Kuv-Api`, {method: 'get'})
					if (anu.error) return reply(anu.error)
					hasil = `*Kota* : ${anu.result.kota}\n*Cuaca* : ${anu.result.cuaca}\n*Angin* : ${anu.result.angin}\n*Suhu* : ${anu.result.suhu}\n*Kelembapan* : ${anu.result.kelembapan}`
					client.sendMessage(from, hasil, text, {quoted: mek})
					await limitAdd(sender)
					break
		case 'kurs': 
		...
		case 'goggleimg':
             //case by +Cognita+
				...
				if (isLimit(sender)) return reply(ind.limitend(pusname))
					client.updatePresence(from, Presence.composing) 
					data = await fetchJson(`https://api.vhtear.com/googleimg?query=${body.slice(11)}&apikey=genbotkey `, {method: 'get'})
					reply(ind.wait())
...
quoted: mek, caption: `Gimana? *Jangan Lupa Follow IG Bot : instagram.com/KUVIANTI INDONESIA NET.bot`
  })
  } catch {
    reply(mess.ferr)
  }
...
quoted: mek, caption: `Wah ganteng kek gua`
  ...
  break
				case 'caklontong':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					if (isLimit(sender)) return reply(ind.limitend(pusname))
					anu = await fetchJson(`https://api-KUVIANTI INDONESIA NETbot.herokuapp.com/api/kuis/caklontong?apikey=ojanganz`, {method: 'get'})
				...
				case 'tebakgambar':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					if (isLimit(sender)) return reply(ind.limitend(pusname))
					anu = await fetchJson(`https://api-KUVIANTI INDONESIA NETbot.herokuapp.com/api/kuis/tebakgambar?apikey=ojanganz`, {method: 'get'})
...
if (isBanned) return reply('```Lu kebanned kontol```')
			...
			case 'ytmp3': // Fix By PojanGanz
					...
					anu = await fetchJson(`https://kuv-api.herokuapp.com/api/yta?url=${body.slice(7)}&apikey=Kuv-Api`, {method: 'get'})
					if (anu.error) return reply(anu.error)
					...
					buffing = await getBuffer(anu.result.image)
					reply(ind.wait())
					buffer = await getBuffer(anu.result.url)
					client.sendMessage(from, buffing, image, {quoted: mek, caption: yta})
					client.sendMessage(from, buffer, audio, {mimetype: 'audio/mp3', filename: `${anu.result.judul}.mp3`, quoted: mek, caption: 'Nih Gan'})
					await limitAdd(sender) 
					break 
             case 'ytmp4':
                    if (args.length < 1) return reply('Urlnya mana um?')
                    if(!isUrl(args[0]) && !args[0].includes('youtu')) return reply(ind.error.Iv)
                    anu = await fetchJson(`https://kuv-api.herokuapp.com/api/ytv?url=${args[0]}&apikey=Kuv-Api`, {method: 'get'})
                    if (anu.error) return reply(anu.error) 
                    yta = `â•­â”€ã€Œ *YOUTUBE MP3 DOWNLOADER* ã€\nâ”‚\nâ”‚â€¢ *Title:* ${anu.result.judul}\nâ”‚â€¢ *Size:* ${anu.result.size}\nâ”‚â€¢ *Link:* https://www.youtu.be/${anu.result.id}\nâ”‚\nâ”‚ Tunggu Sebentar 1 menit Mungkin Agak Lama â”‚ Karna Mendownload Video\nâ•°â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€`
		...
		case 'quotes': 
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					if (isLimit(sender)) return reply(ind.limitend(pusname))
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					anu = await fetchJson(`https://api.zeks.xyz/api/quote?apikey=1kk7EqiopJu9f6Xnd78rZGWBwY7`, {method: 'get'})
		...
		case 'resepmasakan':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					anu = await fetchJson(`https://api.zeks.xyz/api/resep-masak?apikey=apivinz&q=${body.slice(14)}`, {method: 'get'})
					if (anu.error) return reply(anu.error)
		...
		case 'igstalk':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					if (isLimit(sender)) return reply(ind.limitend(pusname))
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					hmm = await fetchJson(`https://api.vhtear.com/api/igptofile?query=${body.slice(9)}&apikey=genbotkey`)
		...
		case 'infofilm': 
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					...
					if (isBanned) return reply('Maaf kamu sudah terbenned!')
					ige = body.slice(10)
					anu = await fetchJson(`https://kuv-api.herokuapp.com/api/film2?q=${ige}&apikey=Kuv-Api`)
 ...
 case 'deteksiwajah':
	...
	if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
	  ...
	  hehe = await getBuffer(`http://lolhuman.herokuapp.com/api/facedetect?apikey=yogipwkey&img=${anu.display_url}`)
	 client.sendMessage(from, hehe, image, {quoted:mek})
	} else {
	  reply('Jangan tambah kan apapun pada command')
	}
	...
	if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
	  ...
	  owgi = await client.downloadAndSaveMediaMessage(ted)
	  anu = await imgbb("3ea1465ef91578a90ee81f7d41c59a1f", owgi)
	  hehe = await fetchJson(`http://lolhuman.herokuapp.com/api/genderdetect?apikey=yogipwkey&img=${anu.display_url}`)
	...
	if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
	  ...
	  owgi = await client.downloadAndSaveMediaMessage(ted)
	  anu = await imgbb("3ea1465ef91578a90ee81f7d41c59a1f", owgi)
	  hehe = await fetchJson(`http://lolhuman.herokuapp.com/api/agedetect?apikey=yogipwkey&img=${anu.display_url}`)
	...
	break
		case 'heroml':  
				...
				if (!isUrl(args[0]) && !args[0].includes('tiktok.com')) return reply(mess.error.lv)
					 ige = body.slice(12)
                     anu = await fetchJson(`http://kuvianti-api.herokuapp.com/api/download/tiktok?url=${args[0]}&apikey=Kuv-Api`, {method: 'get'})
					if (anu.error) return reply(anu.error)
...
case 'public':
				case 'publik':
				   publik = true
				client.sendMessage(client.key.remoteJid, `「 *PUBLIC-MODE* 」`, MessageType.text, { quoted:mek})
			break
				case 'self':
           case 'privat':
				   publik = false
				client.sendMessage(client.key.remoteJid, `「 *SELF-MODE* 」`, MessageType.text, { quoted:mek})
			break
					/*
                case 'kickall':
					if (!isOwner) return reply(ind.ownerb())
		...
		case 'grouplist':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
					client.updatePresence(from, Presence.composing) 
					teks = `\`\`\`Ini adalah list group KUVIANTI INDONESIA NET-BOT :\n\n\`\`\``
					no = 0
		...
		case 'help': 
		case 'menu':
            if (!isBotGroupAdmins) return reply(`「BOT NOT A ADMIN」 \n_MAAF, BOT TIDAK DAPAT MENAMPILKAN COMMAND_`)
                 if (!isRegistered) return reply( ind.noregis())
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
...
┣ꦼꦽ➳      〘 *INFO BOT* 〙─────
┣━━━━━━━━━━━━━━━━━━━⊗
┠⊷   Nama : KUVIANTI INDONESIA NET BOT✓
┠⊷   WhatsApp : Wa.me/6287717710182
┠⊷   Instagram : instagram.com/rinkashikimoz_
┠⊷   GitHub : Github.com/NaswariTeam
...
┃• ALPIN OFC
┃• DAPPA
┃• MEM KUVIANTI INDONESIA NETBOT
┃• SAPUSA BOT
┃• VINZ 
┃• And All Team Naswari
┃ •MAAF KALO APIKEY TIDAK BISA DIGUNAKAN
┗━━━━━━━━━━━━━━━━━━⊗
┏━━━━━━━━━━━⊗ 
┣ꦼꦽ➣ 📄NOTE : 
┣━━━━━━━━━━━⊗
...
//////tels = body.slice(6)
///try {
////anu = await fetchJson(`https://kuv-api.herokuapp.com/api/wiki?q=${tels}&apikey=Kuv-Api`, {
/// method: 'get'
//}
////)
/////reply(anu.result
...
if (isBanned) return reply('```Lu kebanned kontol```')
  ...
  teks = `┣ꦼꦽ➣  *Nama bot* : ${me.name}
  ┣ꦼꦽ➣   *Nomor Bot* : @${me.jid.split('@')[0]}
  ┣ꦼꦽ➣   *Owner* : COGNITA
  ┣ꦼꦽ➣   *Prefix* : [ ${prefix} ]
  ┣ꦼꦽ➣   *Total Block Contact* : ${blocked.length}
  ┣ꦼꦽ➣   *The bot is active on* : ${kyun(uptime)}
  ┣ꦼꦽ➣   *Total User* : ${_registered.length} User
  ┣ꦼꦽ➣   *Total Chat* : 1072`
...
caption: teks, contextInfo: {
  ...
  break
		...
		case 'lpr':
					...
					reply('Masalah telah di laporkan ke owner KUVIANTI INDONESIA NET, Laporan palsu atau main² tidak akan ditanggapi.')
					break
		...
		case 'request':
					...
					client.sendMessage('6289666262976@s.whatsapp.net', options, text, {quoted: mek})
					client.sendMessage('6289666262976@s.whatsapp.net', options, text, {quoted: mek})
					reply('REQUEST ANDA TELAH SAMPAI KE OWNER KUVIANTI INDONESIA NET, Requests palsu atau main² tidak akan ditanggapi.')
					break
	...
	case 'self':
		...
		case 'animehug':
				...
				if (isBanned) return reply('Maaf kamu sudah terbenned!')
					...
					ranp = getRandom('.gif')
					rano = getRandom('.webp')
					anu = await fetchJson('https://kuv-api.herokuapp.com/api/hug?apikey=Kuv-Api', {method: 'get'})
					if (anu.error) return reply(anu.error)
					exec(`wget ${anu.result} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=15 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
						fs.unlinkSync(ranp)
						if (err) return reply(mess.error.stick)
		...
		case 'kelinci':
				...
				if (!isNsfw) return reply(ind.nsfwoff())
					ranp = getRandom('.gif')
					rano = getRandom('.webp')
					anu = await fetchJson('https://kuv-api.herokuapp.com/api/kiss?apikey=Kuv-Api', {method: 'get'})
					if (anu.error) return reply(anu.error)
					exec(`wget ${anu.result} -O ${ranp} && ffmpeg -i ${ranp} -vcodec libwebp -filter:v fps=fps=15 -lossless 1 -loop 0 -preset default -an -vsync 0 -s 512:512 ${rano}`, (err) => {
						fs.unlinkSync(ranp)
						if (err) return reply(ind.stikga())
				...
				if (!isNsfw) return reply(ind.nsfwoff())
				    try {
						res = await fetchJson(`https://kuv-api.herokuapp.com/api/husbu?apikey=Kuv-Api`)
						buffer = await getBuffer(res.image)
						client.sendMessage(from, buffer, image, {quoted: mek, caption: 'Ingat! Cintai husbumu'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
				...
				if (!isNsfw) return reply(ind.nsfwoff())
					gatauda = body.slice(8)
					reply(ind.wait())
					anu = await fetchJson(`https://kuv-api.herokuapp.com/api/randomanime?apikey=Kuv-Api`, {method: 'get'})
					buffer = await getBuffer(anu.result)
					client.sendMessage(from, buffer, image, {quoted: mek})
					await limitAdd(sender)
					break
				//anime
				case 'waifu':
				   	anu = await fetchJson(`https://kuv-api.herokuapp.com/api/waifu`, {method: 'get'})
    ...
    case 'linkgc':
		...
		case 'hargapremium':
					...
					break
		case 'buypremium':
					client.sendMessage(from, 'Ingin membeli premium?\nHarap hubungi kami : wa.me/6287717710182',MessageType.text, { quoted: mek} )
					break
		...
		case 'wame':
                 ...
                 if (!isRegistered) return reply( ind.noregis())
  					...
  					client.updatePresence(from, Presence.composing) 
  					options = {
  					text :`「 *KUVIANTI INDONESIA NET BOT WHATSAPP* 」\n\n_Request by_ : *@${sender.split("@s.whatsapp.net")[0]}\n\nYour link WhatsApp : *https://wa.me/${sender.split("@s.whatsapp.net")[0]}*\n*Or ( / )*\n*https://api.whatsapp.com/send?phone=${sender.split("@")[0]}*`,
  					contextInfo: { mentionedJid: [sender] }
  					}
		...
		case 'bc': 
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `*「 BROADCAST KUVIANTI INDONESIA NET 」*\n\n${body.slice(4)}`)
						}
						reply('*Suksess broadcast* ')
					}
					break
		case 'bcc': 
				if (!isAdmin) return reply('*Only Admin bot*')
					...
					if (isMedia && !mek.message.videoMessage || isQuotedImage) {
						...
						for (let _ of anu) {
							sendMess(_.jid, `*「 BROADCAST KUVIANTI INDONESIA NET-BOT 」*\n\n${body.slice(4)}`)
						}
						reply('*Suksess broadcast* ')
					}
					break
		...
		case 'group':
            ...
            case 'creator':
            case 'developer':
                  client.sendMessage(from, {displayname: "Jeff", vcard: vcard1}, MessageType.contact, { quoted: mek})
                  client.sendMessage(from, {displayname: "Jeff", vcard: vowner}, MessageType.contact, { quoted: mek})
                  client.sendMessage(from, {displayname: "Jeff", vcard: vdev}, MessageType.contact, { quoted: mek})
		...
		case 'toimg':
				...
				if (!isQuotedSticker) return reply('*Reply/Tag sticker!*')
					...
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						...
						if (err) return reply(ind.stikga())
						buffer = fs.readFileSync(ran)
						client.sendMessage(from, buffer, image, {quoted: mek, caption: '*DAH JADI KAK* '})
						fs.unlinkSync(ran)
					})
					await limitAdd(sender)
					break
...
if (budy.includes(`shalom`)) {

                  reply(`shalom juga ${pushname}`)

                  }
 if (budy.includes(`GBU`)) {

                  reply(`GBU to ${pushname}`)
